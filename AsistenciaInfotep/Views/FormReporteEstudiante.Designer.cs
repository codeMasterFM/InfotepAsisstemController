...
{
	partial class FormReporteEstudiante
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.infotedbDataSet21 = new infotepAssistControl.infotedbDataSet2();
			this.infotedbDataSet21bindingSource1 = new System.Windows.Forms.BindingSource(this.components);
			this.panel1.SuspendLayout();
			this.gbxFiltros.SuspendLayout();
			this.panelSubmenuReporte.SuspendLayout();
			this.panelFechaPersonalizada.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.infotedbDataSet21)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.infotedbDataSet21bindingSource1)).BeginInit();
			this.SuspendLayout();
			// 
			// panel1
			// 
			...
			this.panelFechaPersonalizada.Visible = false;
			// 
			// panel4
			// 
			...
			this.reportViewer1.LocalReport.ReportEmbeddedResource = "infotepAssistControl.ReportAsistenciaEstudiantes.rdlc";
			...
			// infotedbDataSet21
			// 
			this.infotedbDataSet21.DataSetName = "infotedbDataSet2";
			this.infotedbDataSet21.SchemaSerializationMode = System.Data.SchemaSerializationMode.IncludeSchema;
			// 
			// infotedbDataSet21bindingSource1
			// 
			this.infotedbDataSet21bindingSource1.DataSource = this.infotedbDataSet21;
			this.infotedbDataSet21bindingSource1.Position = 0;
			// 
			// FormReporteEstudiante
			// 
			...
			this.Name = "FormReporteEstudiante";
			this.Text = "FormReporteEstudiante";
			this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
			this.Load += new System.EventHandler(this.FormReporteEstudiante_Load);
			...
			((System.ComponentModel.ISupportInitialize)(this.infotedbDataSet21)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.infotedbDataSet21bindingSource1)).EndInit();
		...
		private infotedbDataSet2 infotedbDataSet21;
		private System.Windows.Forms.BindingSource infotedbDataSet21bindingSource1;
		public System.Windows.Forms.Panel panelFechaPersonalizada;
	}
}